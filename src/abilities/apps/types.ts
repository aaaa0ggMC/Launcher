...
//
// These types are owned by the `apps` ability and stay here. The framework
// shell does NOT import them — it interacts with the ability generically
// through IPC commands and registered quick actions.
...
/** Result of a process launch — the apps launch service contract. */
