...
<template>
  <div class="yarj-prefs-wrapper d-flex flex-column ga-6">
    ...
    <template v-else>
          ...
          <v-col cols="12" md="6">
            ...
            <v-select
              ...
              :items="[
                ...
                { title: t('yarj.prefs.projMercator', '2D 平面地图 (Mercator)'), value: 'mercator' }
              ]"
              density="compact"
              variant="outlined"
              hide-details
          ...
          <v-col cols="12" md="6">
            ...
            <v-select
              ...
              :items="[
                ...
                { title: t('yarj.prefs.langLocal', '当地原生语言 (Local Native)'), value: 'local' }
              ]"
              density="compact"
              variant="outlined"
              hide-details
      ...
      <v-card variant="tonal" rounded="xl" class="pa-5">
        <div class="d-flex align-center ga-3 mb-4">
          <v-icon color="primary" size="24">mdi-timelapse</v-icon>
          <div>
            <div class="text-subtitle-1 font-weight-bold">
          ...
          <v-col cols="12" md="6">
            ...
            <v-select
              ...
              :items="[
                ...
                { title: t('yarj.prefs.speedCinematic', '舒缓电影感 (2.5s)'), value: 'cinematic' },
      ...
      <v-card variant="tonal" rounded="xl" class="pa-5">
        <div class="d-flex align-center ga-3 mb-4">
          <v-icon color="primary" size="24">mdi-map-marker-distance</v-icon>
          <div>
            <div class="text-subtitle-1 font-weight-bold">
      ...
      <v-card class="pa-5 rounded-xl border">
        <div class="d-flex align-center justify-space-between pb-3 border-b mb-4">
          <div class="d-flex align-center ga-3">
            <v-icon color="primary" size="24">mdi-filter-cog-outline</v-icon>
            <div>
              <div class="text-subtitle-1 font-weight-bold">
                {{ t('yarj.prefs.filtersTitle', '照片展示高级筛选规则 (Photo Filters)') }}
              </div>
              <div class="text-caption on-surface-variant">
                {{
                  t(
